...
All'interno della sezione \textbf{Networking Services} i casi rappresentativi sono i controlli 7.1 e 7.2. \\
...
All'interno della sezione \textbf{Security Services} i casi rappresentativi fanno parte della sotto sezione 8.1.x dedicati a Microsoft Defender for Cloud. \\
...
All'interno della sezione \textbf{Virtual Machines} il caso rappresentativo è sul controllo \textit{20.2 ( Ensure that 'OS and Data' disks are encrypted with Customer Managed Key (CMK) (Automated) )}. \\
